...
- [Описание требований и архитектуры](#описание-требований-и-архитектуры)
  ...
  - [Основные диаграммы решения](#основные-диаграммы-решения)
    - [Уровень 1: Контекст](#уровень-1-контекст)
    - [Уровень 1+: Диаграмма ограниченных контекстов](#уровень-1-диаграмма-ограниченных-контекстов)
...
Уровень 1: Схема системного контекста. Детальнее по ссылке [Модель контекстной диаграммы](context/context.md)
...
- [ADR.005 Выбор интеграционного протокола взаимодействия: Rest, gRpc](adr/adr005.md)
- [ADR.005 Выбор базы данных MariaDB или MongoDB](adr/adr006.md)

## Основные диаграммы решения
### Уровень 1: [Контекст](context/context.md)
### Уровень 1+: [Диаграмма ограниченных контекстов](context/context_2.md)
### Уровень 2: [Контейнеры](container/container.md)
